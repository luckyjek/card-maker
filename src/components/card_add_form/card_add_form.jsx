...
const CardAddForm = ({ onAdd }) => {
    ...
    return(
        <form ref={formRef} className={styles.form}>
            ...
            <input
            ref={emailRef} className={styles.input} type="text" name="email" placeholder="Maile"/>
            <textarea
            ref={messageRef} className={styles.textarea} name="message" placeholder="Massage"></textarea>
